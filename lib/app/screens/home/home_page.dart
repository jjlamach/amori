          ...
          leading: BlocBuilder<FavoriteCubit, FavoriteState>(
            builder: (context, state) {
              return state.maybeWhen(
                favorite: (value) => IconButton(
                  onPressed: () =>
                      context.read<FavoriteCubit>().unfavoriteFeeling(false),
                  icon: const Icon(
                    Icons.favorite,
                    size: 40,
                    color: Colors.red,
                ...
                unfavorite: (value) => IconButton(
                  onPressed: () =>
                      context.read<FavoriteCubit>().favoriteFeeling(true),
                  icon: const Icon(
                        ...
                        loggedIn: (user, feelings) {
                          return BlocBuilder<EmotionCubit, EmotionState>(
                            builder: (context, state) {
                              return state.maybeWhen(
                                emotionSelected:
                                    (emotion, emotionDescription, tag) =>
                                        Column(
                                  children: [
                                    SizedBox(
                                      height:
                                      ...
                                      onPressed: () {
                                        AutoRouter.of(context).push(
                                          SelectNewEmotionView(
                                            ...
                                            emotionDescription: feelings
                                                .last.feelingDescription,
                                          ),
                                        );
                                      },
                                      child: Padding(
